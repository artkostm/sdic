...
import by.artkostm.reflections.exceptions.ScannerException;
import by.artkostm.reflections.exceptions.ScannerException.ScannerType;

public class PackageClassScanner implements ClassScanner<Class<?>, String>
{
    ...
    public Set<Class<?>> scan(String... packageNames)
    {
        ...
        for (final String packageName : packageNames)
        {
            ...
            {
                throw new ScannerException("Cannot get classes from " + packageName + "package.", e, ScannerType.PACKAGE);
            }
        }
        return classes;
    }
